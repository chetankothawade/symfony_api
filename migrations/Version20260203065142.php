...
final class Version20260203065142 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE password_reset_tokens (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, email VARCHAR(250) NOT NULL, token VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX password_reset_tokens_email_unique (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
